...
public class _10_substring {
    public static void main(String[] args) {
        ...
        System.out.println(result.substring(28)); // returns (0.82 seconds)

        System.out.println(result.substring(result.indexOf('(')));  // returns (0.82 seconds)
        System.out.println(result.substring(result.lastIndexOf('0')-1));

        String sentence = "You are my sunshine";


        String sentence1 = "I love food";
        System.out.println(sentence1.substring(0,7));
        ...
        System.out.println("Last word is = " + sentence.substring(sentence.lastIndexOf(' '),sentence.length()));
