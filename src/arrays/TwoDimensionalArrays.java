...
public class TwoDimensionalArrays {
    public static void main(String[] args) {
        ...
        System.out.println(studentGroups[1][1]);  // Torrie
        ...
        // How to get the third group
        System.out.println(Arrays.toString(studentGroups[2])); // Abe and Data

        //How to print all groups
